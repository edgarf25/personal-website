      ...
      <div id='about' className="about">
            <div className="about-header">
                <div className="about-text">
                    ...
                    <p>My <span>passion for technology and problem-solving</span> has led me to pursue a career in <span>software engineering</span>. I am excited to leverage my skills and knowledge to create innovative solutions that make a positive impact on the world. I am a <span>quick learner</span>, a <span>team player</span>, and a <span>creative thinker</span> who is always looking for <span>new challenges</span> to tackle.</p><br/>
                    <p>When I&apos;m not coding, you can find me exploring the great outdoors, playing video games, or experimenting with new recipes in the kitchen. I am always up for an adventure and love trying new things. Feel free to reach out if you&apos;d like to <span>connect or collaborate on a project</span>!</p><br/>
